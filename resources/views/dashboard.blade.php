        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <x-header-list>
                        <x-slot:total_debt_sum>{{$total_debt_sum??''}}</x-slot:total_debt_sum>
                            ...
                            <x-list-debtors>
                                ...
                                <x-slot:delete>
                                    <form method="POST" action="{{ route('user.destroy', $debtor->id) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" onclick="return confirm('Bu mijozni o\'chirishga aminmisiz? Agar mijoz o\'chirilsa uning barcha amaliyotlari ham Tarix sahifasidan o\'chirib tashlanadi ! ')">
